      ...
      <footer className="bg-black text-white border-t border-slate-800 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">RUL Prediction</h3>
            <p className="text-slate-400">
              LSTM deep learning models predict tool remaining useful life with 95%+ accuracy
            </p>
          </div>
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
            ...
            <p className="text-slate-400">
              Isolation Forest detects equipment anomalies in real-time with minimal false positives
            </p>
          </div>
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Process Optimization</h3>
            <p className="text-slate-400">
              XGBoost recommendations optimize feed rate and spindle speed for efficiency gains
            </p>
          </div>
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Multi-Protocol</h3>
            <p className="text-slate-400">
              Support for MTConnect, OPC-UA, Modbus, and MQTT—works with any CNC controller
            </p>
          </div>
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
            ...
            <p className="text-slate-400">
              Live streaming via Kafka and WebSocket with 1-2 second update intervals
            </p>
          </div>
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">ROI Metrics</h3>
            <p className="text-slate-400">
              Track cost savings: tools (~$50K/yr), downtime (~$75K/yr), scrap (~$20K/yr)
            </p>
          </div>
        </div>

        {/* Stats Section */}
        <div className="bg-gradient-to-r from-blue-900/40 to-cyan-900/40 border border-slate-700 rounded-lg p-8 text-center">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div>
              <p className="text-3xl font-bold text-cyan-400">700%</p>
              <p className="text-slate-300 mt-2">Average ROI</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-green-400">1.4</p>
              <p className="text-slate-300 mt-2">Month Payback</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-blue-400">$127K</p>
              <p className="text-slate-300 mt-2">Annual Savings</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-purple-400">4</p>
              <p className="text-slate-300 mt-2">CNC Protocols</p>
            </div>
          </div>
        </div>
      </div>
